...
function initSlideShow (id) {
    var arrowsStyle = {'position':'absolute','top':'50%','margin-top':'-31px','background-color':'#333','background-image':'url(https://dhx9m59k8ysce.cloudfront.net/img/nav_sprite.png)','color':'white','height':'62px','width':'44px','font-size':'60px','font-weight':'bold','line-height':'62px','cursor':'pointer','text-align':'center','display':'none'};
