/* exported loadcomment, init_repeat_cmt, showcmt, voteComment, cmt_reply, login, clickToSubmitComment, logout, checkLogin, socialLogin, binding, phoneLogin, resetPhoneLogin, showPhoneFTCBinding, showPhoneLogin */
// MARK: User Comments
...
function showPhoneFTCBinding() {
    document.querySelector('.nologincomment').style.display = 'none';
    document.querySelector('.logincomment').style.display = 'none';
...
function showPhoneLogin() {
    document.querySelector('.nologincomment').style.display = 'none';
    document.querySelector('.logincomment').style.display = 'none';
    document.getElementById('phone-captcha').style.display = 'none';
