...
function abTest() {
	...
	link.rel  = 'stylesheet';
	link.type = 'text/css';
	link.href = (/localhost|127\.0|192\.168/.test(window.location.href)) ? 'styles/main-barrier.css': 'https://d28dmc8fp041dv.cloudfront.net/n/main-barrier.css?'+cssVersionNumber;
